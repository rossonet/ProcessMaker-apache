...
# Extra
LABEL version="3.5.8"
LABEL description="ProcessMaker 3.5.8 Comunity Docker Container - Apache"
...
RUN wget -O "/tmp/processmaker-3.5.8.tar.gz" \
      "https://www.rossonet.net/dati/pmos/processmaker-3.5.8-community.tar.gz"
